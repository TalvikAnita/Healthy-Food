...
let tabs = document.querySelectorAll('.tabheader'),
    ...
    function showThanksModal(message) {
        ...
        <div class="modal__content">
            ...
            <div class="modal__title">${message.title}</div>
        </div>
        `;
    ...
    const sliders = document.querySelectorAll('.offer__slide'),
        ...
        slidesWrapper = document.querySelector('.offer__slides-wrapper'),
        ...
        const indicators = document.createElement('ol'),
            ...
            const result = document.querySelector('.calcuating__result span');
            ...
            initLocalSettings('.calulating__choose_big div', 'calculating__choose-item_active');
